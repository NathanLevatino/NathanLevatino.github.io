(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 180, 170, 100, 1);
        collectable.create(type.steve, 160, 500, 9999, .01);
        collectable.create(type.max, 400, 400, 9999, .01);
        collectable.create(type.max, 120, 170, 9999, .3);
